  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (this.disableInput === true) {
        sendAxios(this, request(hiCustomer.update) + this.editing, param)
      } else {
        sendAxios(this, request(hiCustomer.add), param)
      }
    },
    onCancel() {
      this.editbox = false;
    ...
    onDelete() {
      ...
      sendAxios(this, request(hiCustomer.delete) + this.editing, param);
    }
  }
};
</script>
